...
import useWinSize from '../../common/components/useWinSize';
import './Slider.css';
...
const Slider = memo(function Slider(props) {
    ...
    const { width: winWidth } = useWinSize(); // 通过自定义useHooks来监听window的resize事件，获取width，height
    ...
    // 通过range useRef获取dom元素，getComputedStyle获得元素的width,然后再通过useRef存储在 rangWidth中；
    useEffect(() => {
